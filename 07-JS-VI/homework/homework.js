...
function mayuscula(nombre) {
  ...
  //.slice corta nuestro string en donde le digamos (0) o (3) o ...
  //.toUpperCase() nos devuelve la misma letra en mayuscula
  //.toLowerCase() nos devuelve la misma letra en minuscula
}
...
function forEach(array, cb) {
  ...
  //array.forEach(elemento=>cb(elemento));    ->    otra forma de escribirlo mas abreviado
}
